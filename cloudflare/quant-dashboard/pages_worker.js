...
const CATALOGUE_INDEX_CONTRACT_VERSION=3;
...
async function load(){
  ...
  try{
    ...
    const cards=[["模型实际触发候选",triggeredCompanyCount],["待行动确认/附加条件（非信号）",conditionalOnlyCompanyCount],["资料待补候选（非信号）",pendingOnlyCompanyCount],["当前不买（其余公司）",currentNoBuyCount],["其中待确认仓位",actionConfirmationCount],["全部客观资料缺口",evidenceGapCompanyCount],["缺口可能改变结论",decisionRelevantGapCount]];
